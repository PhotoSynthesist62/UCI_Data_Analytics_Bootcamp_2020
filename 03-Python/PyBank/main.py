...
print("The Greatest Increase during the period was " + str(increase) + " on " + str(greatest_incr_date))
# The greatest decrease in profits (date and amount) over the entire period
print("The Greatest Decrease during the period was " + str(decrease) + " on " + str(greatest_dcr_date))